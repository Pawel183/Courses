...
public class ReviewServiceTests {
    ...
    public void ReviewService_CreateReview_ReturnsReviewDto() {
        ...
        ReviewDto savedReviewDto = reviewService.createReview(pokemonId, reviewDto);
    ...
    public void ReviewService_GetReviewById_ReturnReviewDto() {
        ...
        when(pokemonRepository.findById(reviewId)).thenReturn(Optional.of(pokemon));
        when(reviewRepository.findById(pokemonId)).thenReturn(Optional.of(review));

        ReviewDto returnReview = reviewService.getReviewById(reviewId, pokemonId);
