...
public class ReviewRepositoryTests {
    ...
    public void ReviewRepository_FindById_ReturnsSavedReview() {
        ...
        Review reviewReturn = reviewRepository.findById(Integer.valueOf(review.getId())).get();
    ...
    public void ReviewRepository_UpdateReview_ReturnReview() {
        ...
        Review reviewSave = reviewRepository.findById(Integer.valueOf(review.getId())).get();
    ...
    public void ReviewRepository_ReviewDelete_ReturnReviewIsEmpty() {
        ...
        reviewRepository.deleteById(Integer.valueOf(review.getId()));
        Optional<Review> reviewReturn = reviewRepository.findById(Integer.valueOf(review.getId()));
